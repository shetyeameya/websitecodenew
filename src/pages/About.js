              ...
              <div className="page">
                ...
                <div className="paratext">
                    <Row>
                        <Col>
                            <p>
                                Albert Einstein’s famous words ring true every time I feel a bit deflated or when I do not
                                live up to my own expectations; I have learnt that moving on and addressing the issues at 
                                stake, is the superlative solution to virtually all problems This has made me believe in 
                                setting short-term goals for myself and then committing myself totally to achieving them. 
                                Truly, it has been rightly said that well-planned and well thought of actions however small,
                                give a concrete shape to the vision in which they were contemplated. Excellence endures and 
                                sustains. It goes beyond motivation into the realms of inspiration and can be as strong a 
                                uniting force as concrete vision. It does not happen in a vacuum but it needs a collective 
                                obsession, despite hurdles and failures to continue to move ahead, to remain determined; 
                                it is an unending journey, To follow my passion I steered towards subjects that in some way 
                                were related to the amazing world of Electronics and Computers. That which started in high 
                                school at St Marys took me to the Ruia Junior Engineering College and then I enrolled for an 
                                undergraduate education in Electronics from KC College of Engineering. Which led me to 
                                Southern Methodist University for my masters.My journey of learning had just begun!
                                After graduating and receiving my degree I joined Webspun LLC. and learnt a lot. 
                                I build an iOS application from scratch which helped investors get all the necessary 
                                information on stocks publicly listed. After a year I joined RumbleOn and it has been an 
                                exhilarating experience. I joined as Jr Developer for iOS mobile development. 
                                ...
                                and Native developer and back to coding, my passion.
                            </p>
                        </Col>
                    </Row> 
                    <Row>
